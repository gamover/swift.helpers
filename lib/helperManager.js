...
HelperManager.prototype.addHelper = function addHelper (helperName, helper)
{
    if (typeof helperName !== 'string' || !helperName.length)
        throw new error.HelperManagerError('не удалось добавить помощника в HelperManager.' +
    ...
    if (!typeUtil.isObject(helper))
        throw new error.HelperManagerError('не удалось добавить помощника "' + helperName + '" в HelperManager.' +
...
{
    if (typeof helperName !== 'string' || !helperName.length)
        throw new error.HelperManagerError('не удалось получить помощника из HelperManager.' +
            ' Имя помощника не передано или представлено в недопустимом формате');
...
{
    if (typeof helperName !== 'string' || !helperName.length)
        throw new error.HelperManagerError('не удалось удалить помощника из HelperManager.' +
            ' Имя помощника не передано или представлено в недопустимом формате');
